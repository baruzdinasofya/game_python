В данном репозитории представлена игра "Жизнь на прямой". Основная задача этой игры — написать такую строку, где все клетки останутся живы. Данная программа написана на языке Python. 
